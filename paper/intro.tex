...
In many dynamic languages, inspecting a value 
...
%Type tags can also be used to inform dynamic dispatch a function call,
%as they indicate the run-time types of the arguments.
