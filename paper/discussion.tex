...
One approach, adopted by the Julia language~\cite{?}, 
is to use subtyping on tuples~\cite{?}.
...
It needs to be discussed whether such an interpretation provides us with
